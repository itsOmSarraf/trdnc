  ...
  return (
    <div
      ...
      className={`
        ...
        ${hasErrors && !selected ? 'ring-2 ring-amber-500/50' : ''}
      `}
    >
      {/* Validation Error Badge */}
      {hasErrors && (
        <div 
          className="absolute -top-2 -right-2 z-10 flex items-center gap-1 px-1.5 py-0.5 bg-amber-500 text-white text-xs font-bold rounded-full shadow-lg animate-pulse"
